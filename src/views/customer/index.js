...
<Modal
        ...
        >
          ...
          <Modal.Footer>
            ...
            <Button variant="success" onClick={onBuyToken}>Add</Button>
          </Modal.Footer>
</Modal>


<h1 style={{color:"white" ,textAlign:'center' , fontSize:'50px'}}>Search Company</h1>
        
    
        <div className="search_box">
            
            <input type="text" class="form-control" placeholder="Search Company by name" onChange={e => setSearch(e.target.value)} />
            <br />
            <button onClick={setCompany} className='btn btn-warning'>Search</button>
            </div>
           {
